...
struct Gemm : sc_module {
    ...
    void output_result() {
        ...
        try {
            ...
            write_matrix_in_file<T>(result_C, "./data1-25088-4096/MatrixC_output.txt", C_rows, C_cols);
            cout << "=====================输出完成,结果保存到MatrixC_output.txt============================" << endl;
            output_result_done.notify();
            auto end_time = std::chrono::high_resolution_clock::now();
            auto duration = std::chrono::duration_cast<std::chrono::microseconds>(end_time - start_time);
            cout << "GEMM计算时间: " << dec << duration.count()/1000000 << "秒" << endl;
    ...
    public:
        ...
        //输入数据
        string matrixA_file_path = "./data1-25088-4096/matrixA_input.txt";
        string matrixB_file_path = "./data1-25088-4096/matrixB_input.txt"; 
        string matrixC_file_path = "./data1-25088-4096/matrixC_input.txt";
